...
## 6.1 Type inference {#type-inference}
...
### 6.1.1 Return types {#return-types}
...
## 6.2 Undefined and null {#undefined-and-null}
...
### 6.2.1 Nullable/undefined type aliases {#nullableundefined-type-aliases}
...
### 6.2.2 Prefer optional over `|undefined` {#prefer-optional-over-undefined}
...
## 6.3 Use structural types {#use-structural-types}
...
## 6.4 Prefer interfaces over type literal aliases {#prefer-interfaces}
...
## 6.6 Indexable types / index signatures (`{[key: string]: T}`) {#indexable-key-string-type}
...
## 6.7 Mapped and conditional types {#mapped-conditional-types}
...
### 6.8.1 Providing a more specific type {#any-specific}
...
### 6.8.2 Using `unknown` over `any` {#any-unknown}
...
### 6.8.3 Suppressing `any` lint warnings {#any-suppress}
...
## 6.11 Wrapper types {#wrapper-types}
...
## 6.12 Return type only generics {#return-type-only-generics}
